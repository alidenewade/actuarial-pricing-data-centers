...
% A Bayesian Credibility Framework for Wearable-Derived Underwriting
%
% Working paper, Intelligent Actuaries research series, Paper 2
% Author: Ali Denewade
%
% Visual theme: institutional research house --
% deep warm black, bone background, burnt-sienna accent rules.
% Palatino serif body, Helvetica sans headings. Identical theme
% to "A Coupled Power-Thermal-Cyber Framework" (Paper 1).
% ============================================================
...
% --- typography: institutional research house ---
\usepackage{mathpazo}
\linespread{1.08}
...
% --- IA brand palette (identical to Paper 1) ---
...
\usetikzlibrary{arrows.meta,positioning,shapes.geometric,calc,fit,
                ...
                shadows.blur,backgrounds,patterns}
...
% Start every numbered section on a new page. \clearpage on an already-
% fresh page is a no-op, so this is safe to apply globally (including
% the very first section after the table of contents).
...
\newtheoremstyle{ia}
  ...
  {\itshape}
  {0pt}
  {\sffamily\bfseries\color{iadark}}
  {.}
  {.6em}
...
% --- IA callout boxes (identical to Paper 1) ---
...
% ============================================================
% Title page: institutional research house style
% ============================================================
\begin{titlepage}
\thispagestyle{empty}
\vspace*{2.6cm}
...
\noindent
{\sffamily\footnotesize\color{iaaccent}\textsc{Working paper \textbar{} Life and health research}}\\[0.45cm]

{\color{iaaccent}\rule{2.2cm}{1.2pt}}\\[0.85cm]

\noindent
{\sffamily\bfseries\LARGE\color{iadark}%
Mortality of the Quantified Self\\[6pt]
A Bayesian Credibility Framework for\\[6pt]
Wearable-Derived Life Underwriting \par}

\vspace{1.0cm}

\noindent
{\rmfamily\itshape\large\color{iagrey}%
A coupled biometric--statistical--regulatory framework joining
continuous wearable telemetry, classical credibility theory, the
Holmstr\"om informativeness principle, and the privacy-regime
constraints of POPIA, GDPR, and HIPAA. \par}
...
\begin{minipage}[t]{0.55\textwidth}
  ...
  \vspace{2pt}
  Series Paper 2 of the IA research programme.\par
...
\noindent
Continuous biometric telemetry from consumer wearables --- Apple Watch,
Fitbit, Garmin, Oura, Whoop --- now generates sub-second resolution
time series of resting heart rate, heart-rate variability (HRV), sleep
architecture, blood oxygen saturation (SpO$_2$), respiration rate, and
$\dot{V}\mathrm{O}_2$-max proxies for an installed base exceeding 300
million users globally. Major life insurers (John Hancock Vitality,
Manulife Move, Discovery Vitality, Prudential PRUActive) have begun
integrating these signals into underwriting and renewal pricing. The
actuarial question is no longer whether to use wearable telemetry but
\emph{at what credibility weight, under what privacy regime, and with
what fairness constraints}.

We propose a coupled biometric--statistical--regulatory framework for
wearable-derived life underwriting with the following structure. (i) A
\textbf{multi-signal informativeness audit} that ranks resting HR,
nightly HRV, sleep efficiency, SpO$_2$ nadir, and step-count
distribution by their incremental information content with respect to
the all-cause mortality intensity, following the Holmstr\"om
informativeness principle. (ii) A \textbf{Bayesian credibility
formulation} in which the wearable-derived prior intensity
$\lambda_0(\mathbf{w})$ is updated continuously with claims experience
to yield a posterior intensity $\lambda(t)$; we derive the exact
credibility weight $Z(t)$ and its asymptotic behaviour. (iii) An
\textbf{exponential-tilt premium adjustment} that maps the posterior
intensity into a multiplicative life-premium factor with closed-form
sensitivity. (iv) A \textbf{regulatory comparison} of the
admissibility, consent, and rating-band constraints under POPIA (South
Africa), GDPR (EU), HIPAA (USA), and the New York DFS Circular Letter
2019-1 on accelerated underwriting. (v) A worked example pricing a
25-year-old applicant with twelve months of continuous Apple Watch
telemetry against the standard underwriting class.

The framework explicitly addresses three failure modes that current
industry implementations ignore: \textbf{selection-on-wearable
ownership} (wearable owners are a non-representative slice of the
insured population), \textbf{signal substitution bias} (an applicant
can game the contract by wearing the device only when rested), and
\textbf{intergenerational fairness} (the wearable underwriting regime
should not implicitly penalise the next generation of policyholders
who have spent more of their life under surveillance).

\par\vspace{4pt}\noindent{\color{iarule}\rule{\textwidth}{0.3pt}}\par\vspace{6pt}

\noindent
{\sffamily\footnotesize\color{iadark}\textbf{Keywords}}\quad
{\footnotesize wearable telemetry; Bayesian credibility; Holmstr\"om
informativeness; life underwriting; accelerated underwriting; POPIA;
GDPR; selection bias; actuarial fairness; Vitality.}

\par\vspace{3pt}
\noindent
{\sffamily\footnotesize\color{iadark}\textbf{JEL / MSC}}\quad
{\footnotesize G22, D82, K24, 62P05, 91B30.}
...
% Natural-width "Metric" column + \resizebox so the table fits textwidth
% (was p{3.6cm}+cccc at \small, overflowing the right margin by 0.18 in
% on p7 and triggering the 13.25 pt Overfull \hbox warning).
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}lcccc@{}}
\toprule
...
% Multi-line p{} columns are deliberate here — each cell is an
% essay-length regulatory description, not a label.
