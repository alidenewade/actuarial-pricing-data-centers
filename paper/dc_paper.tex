...
% Start every numbered section on a new page. \clearpage on an
% already-fresh page is a no-op, so this is safe to apply globally
% (including the very first section after the table of contents).
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}clccc>{\raggedright\arraybackslash}p{3.2cm}@{}}
\toprule
